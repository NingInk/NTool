...
{
    /// <summary>
    /// 设置克隆子GameObject的localPosition/Scale/Rotation类型。
    /// Set type of cloned child GameObject's localPosition/Scale/Rotation.
    /// </summary>
    public enum TransformCloneType
    {
        /// <summary>
        /// 设置为与原始相同。这是Add方法的默认值。
        /// Set to same as Original. This is default of Add methods.
        /// </summary>
        KeepOriginal,
        /// <summary>Set to same as Parent.
        /// 设置为与Parent相同</summary>
        FollowParent,
    ...
    public static partial class GameObjectExtensions
    {
        ...
        /// <summary>
        /// <para>添加GameObject/Component作为GameObject的子对象。克隆目标器。</para>
        /// </summary>
