...
namespace NTool.Extensions
{
    ...
    {
        public static T Parent<T>(this T self, Component parent)
            where T : Component
        {
        ...
        public static T AsRootTransform<T>(this T self)
            where T : Component
        {
        ...
        public static T LocalIdentity<T>(this T self)
            where T : Component
        {
        ...
        public static T LocalPosition<T>(this T selfComponent, Vector3 localPos)
            where T : Component
        {
        ...
        public static Vector3 LocalPosition<T>(this T selfComponent)
            where T : Component
        {
        ...
        public static T LocalPosition<T>(this T selfComponent, float x, float y, float z)
            where T : Component
        {
        ...
        public static T LocalPosition<T>(this T selfComponent, float x, float y)
            where T : Component
        {
        ...
        public static T LocalPositionX<T>(this T selfComponent, float x)
            where T : Component
        {
            var localPosition = selfComponent.transform.localPosition;
            localPosition.x = x;
        ...
        public static T LocalPositionY<T>(this T selfComponent, float y)
            where T : Component
        {
            var localPosition = selfComponent.transform.localPosition;
            localPosition.y = y;
        ...
        public static T LocalPositionZ<T>(this T selfComponent, float z)
            where T : Component
        {
            var localPosition = selfComponent.transform.localPosition;
            localPosition.z = z;
        ...
        public static T LocalPositionIdentity<T>(this T selfComponent)
            where T : Component
        {
        ...
        public static Quaternion LocalRotation<T>(this T selfComponent)
            where T : Component
        {
        ...
        public static T LocalRotation<T>(this T selfComponent, Quaternion localRotation)
            where T : Component
        {
        ...
        public static GameObject LocalRotation(
        ...
        public static T LocalRotationIdentity<T>(this T selfComponent)
            where T : Component
        {
        ...
        public static T LocalScale<T>(this T selfComponent, Vector3 scale)
            where T : Component
        {
        ...
        public static Vector3 LocalScale<T>(this T selfComponent)
            where T : Component
        {
        ...
        public static T LocalScale<T>(this T selfComponent, float xyz)
            where T : Component
        {
        ...
        public static T LocalScale<T>(this T selfComponent, float x, float y, float z)
            where T : Component
        {
        ...
        public static GameObject LocalScale(
            this GameObject selfComponent,
            float x,
            float y,
            float z
        ...
        public static T LocalScale<T>(this T selfComponent, float x, float y)
            where T : Component
        {
            var localScale = selfComponent.transform.localScale;
            localScale.x = x;
        ...
        public static T LocalScaleX<T>(this T selfComponent, float x)
            where T : Component
        {
            var localScale = selfComponent.transform.localScale;
            localScale.x = x;
        ...
        public static float LocalScaleX<T>(this T self)
            where T : Component
        {
            return self.transform.localScale.x;
        }

        public static T LocalScaleY<T>(this T self, float y)
            where T : Component
        {
            var localScale = self.transform.localScale;
            localScale.y = y;
        ...
        public static float LocalScaleY<T>(this T self)
            where T : Component
        {
        ...
        public static T LocalScaleZ<T>(this T selfComponent, float z)
            where T : Component
        {
            var localScale = selfComponent.transform.localScale;
            localScale.z = z;
        ...
        public static float LocalScaleZ<T>(this T self)
            where T : Component
        {
        ...
        public static T LocalScaleIdentity<T>(this T selfComponent)
            where T : Component
        {
        ...
        public static T Identity<T>(this T selfComponent)
            where T : Component
        {
        ...
        public static T Position<T>(this T selfComponent, Vector3 position)
            where T : Component
        {
        ...
        public static Vector3 Position<T>(this T selfComponent)
            where T : Component
        {
        ...
        public static T Position<T>(this T selfComponent, float x, float y, float z)
            where T : Component
        {
        ...
        public static T Position<T>(this T selfComponent, float x, float y)
            where T : Component
        {
        ...
        public static T PositionIdentity<T>(this T selfComponent)
            where T : Component
        {
            selfComponent.transform.position = Vector3.zero;
            return selfComponent;
        ...
        public static T PositionX<T>(this T selfComponent, float x)
            where T : Component
        {
            var position = selfComponent.transform.position;
            position.x = x;
        ...
        public static T PositionX<T>(this T selfComponent, Func<float, float> xSetter)
            where T : Component
        {
            var position = selfComponent.transform.position;
        ...
        public static T PositionY<T>(this T selfComponent, float y)
            where T : Component
        {
            var position = selfComponent.transform.position;
            position.y = y;
        ...
        public static T PositionY<T>(this T selfComponent, Func<float, float> ySetter)
            where T : Component
        {
            var position = selfComponent.transform.position;
        ...
        public static T PositionZ<T>(this T selfComponent, float z)
            where T : Component
        {
            var position = selfComponent.transform.position;
            position.z = z;
        ...
        public static T PositionZ<T>(this T self, Func<float, float> zSetter)
            where T : Component
        {
            var position = self.transform.position;
        ...
        public static T RotationIdentity<T>(this T selfComponent)
            where T : Component
        {
            selfComponent.transform.rotation = Quaternion.identity;
            return selfComponent;
        ...
        public static T Rotation<T>(this T selfComponent, Quaternion rotation)
            where T : Component
        {
        ...
        public static Quaternion Rotation<T>(this T selfComponent)
            where T : Component
        {
        ...
        public static Vector3 Scale<T>(this T selfComponent)
            where T : Component
        {
        ...
        public static T DestroyChildren<T>(this T selfComponent)
            where T : Component
        {
        ...
        public static T DestroyChildrenWithCondition<T>(
        ...
        public static T AsLastSibling<T>(this T selfComponent)
            where T : Component
        {
        ...
        public static T AsFirstSibling<T>(this T selfComponent)
            where T : Component
        {
        ...
        public static T SiblingIndex<T>(this T selfComponent, int index)
            where T : Component
        {
        ...
        public static T Position2D<T>(this T self, Vector2 position)
            where T : Component
        {
            return self.Position(position.x, position.y);
        }
        ...
        public static T LocalPosition2D<T>(this T self, Vector2 position)
            where T : Component
        {
            return self.LocalPosition(position.x, position.y);
        }
        ...
        public static T SyncPositionFrom<T>(this T self, GameObject from)
            where T : Component
        {
            return self.Position(from.Position());
        }
        ...
        public static T SyncPositionFrom<T>(this T self, Component from)
            where T : Component
        {
            return self.Position(from.Position());
        }
        ...
        public static T SyncPosition2DFrom<T>(this T self, GameObject from)
            where T : Component => self.Position2D(from.Position2D());

        public static GameObject SyncPosition2DFrom(this GameObject self, Component from) =>
            self.Position2D(from.Position2D());

        public static T SyncPosition2DFrom<T>(this T self, Component from)
            where T : Component => self.Position2D(from.Position2D());
        ...
        public static T SyncPositionTo<T>(this T self, GameObject to)
            where T : Component
        {
            to.Position(self.Position());
            return self;
        ...
        public static T SyncPositionTo<T>(this T self, Component to)
            where T : Component
        {
            to.Position(self.Position());
            return self;
        ...
        public static T SyncPosition2DTo<T>(this T self, GameObject to)
            where T : Component
        {
            to.Position2D(self.Position2D());
            return self;
        ...
        public static T SyncPosition2DTo<T>(this T self, Component to)
            where T : Component
        {
            to.Position2D(self.Position2D());
            return self;
        ...
        public static T LocalEulerAngles<T>(this T self, Vector3 localEulerAngles)
            where T : Component
        {
            self.transform.localEulerAngles = localEulerAngles;
            return self;
        ...
        public static T LocalEulerAnglesZ<T>(this T self, float z)
            where T : Component
        {
            self.LocalEulerAngles(self.LocalEulerAngles().Z(z));
            return self;
        ...
        public static T EulerAngles<T>(this T self, Vector3 eulerAngles)
            where T : Component
        {
            self.transform.eulerAngles = eulerAngles;
            return self;
        ...
        public static T EulerAnglesZ<T>(this T self, float z)
            where T : Component
        {
            self.EulerAngles(self.EulerAngles().Z(z));
            return self;
